...
#line 188 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\api\\wifi\\wifi_promisc.c"
...
#line 403 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\api\\wifi\\wifi_promisc.c"
...
#line 420 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\api\\wifi\\wifi_promisc.c"
	}
		...
		while(1) {
			...
			if((current_time - start_time) < (duration * ( ( uint32_t ) 1000 ))) {
				...
				if(frame) {
					...
					rtl_printf(", len=%d", frame->len);
					rtl_printf(", RSSI=%d", frame->rssi);
#line 508 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\api\\wifi\\wifi_promisc.c"
					vPortFree((void *) frame);
				}
				else
					vTaskDelay(1);	
...
#line 525 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\api\\wifi\\wifi_promisc.c"
	}
...
static void easy_promisc_callback_all(unsigned char *buf, unsigned int len, void* userdata)
{
...
static void easy_promisc_test_all(int duration, unsigned char len_used)
{
       int ch;
	unsigned int start_time;
	struct eth_frame *frame;
	...
	wifi_enter_promisc_mode();
	wifi_set_promisc(RTW_PROMISC_ENABLE_2, easy_promisc_callback_all, len_used);
...
#line 1015 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\api\\wifi\\wifi_promisc.c"
					vPortFree((void *) frame);
				}
				else
					vTaskDelay(1);	
...
#line 1032 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\api\\wifi\\wifi_promisc.c"
	}
...
void my_cmd_pr()
{
     easy_promisc_test_all(3,0);
}

void cmd_promisc(int argc, char **argv)
{
	int duration;
#line 1057 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\api\\wifi\\wifi_promisc.c"
...
#line 1072 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\api\\wifi\\wifi_promisc.c"
}
