#line 1 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
...
#line 3 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
...
#line 4 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
...
#line 5 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
...
#line 6 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
...
#line 7 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
...
#line 8 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
...
#line 9 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
...
#line 10 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
#line 1 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\wifi802ee.h"



 
#line 14 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\wifi802ee.h"
typedef unsigned char       uint8_t;
...
#line 11 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
...
int my_promisc_get_fixed_channel(void *fixed_bssid, uint8_t *ssid, int *ssid_length)
{
  ...
  if( _memcmp(mac_mobile_old, mac, 6)!= 0 )
  {
    if( vdata_insert_device(mac, g_second) > 0 ){
      if( mac2 == 0 ){
          ...
          rtl_sprintf(vdata_macprint,"01|%02X%02X%02X%02X%02X%02X|%02X\n\0",mac[0],mac[1],mac[2],mac[3],mac[4],mac[5],rssi);  
          ...
          rtl_sprintf(vdata_macprint,"02|%02X%02X%02X%02X%02X%02X|%02X|%02X%02X%02X%02X%02X%02X|%02d|\0",
...
void print_mac_router(uint8_t *mac, uint8_t rssi, uint8_t ssid_len, uint8_t *ptr_ssid )
{
  ...
  if( _memcmp(mac_bssid_old, mac, 6) != 0 ){
    if( vdata_insert_router( mac,g_second) > 0 ){
        ...
        rtl_sprintf(vdata_routerprint,"00|%02X%02X%02X%02X%02X%02X|%02X|%02d|",mac[0],mac[1],mac[2],mac[3],mac[4],mac[5],rssi,ssid_len);
...
#line 452 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
...
rtw_packet_filter_info_t my_paff_array[5]={0, 0, 0, 0, 0};
static uint8_t my_packet_filter_enable_num = 0;
...
void my_promisc_init_packet_filter()
{
	int i = 0;
	for(i=0; i<5; i++){
		my_paff_array[i].filter_id = 10;
		my_paff_array[i].enable = 0;
		my_paff_array[i].patt.mask_size = 0;
		my_paff_array[i].rule = RTW_POSITIVE_MATCHING;
		my_paff_array[i].patt.mask = 0;
		my_paff_array[i].patt.pattern = 0;
	}
	my_packet_filter_enable_num = 0;
}

int my_promisc_add_packet_filter(uint8_t filter_id, rtw_packet_filter_pattern_t *patt, rtw_packet_filter_rule_t rule)
{
	int i = 0;
	while(i < 5){
		if(my_paff_array[i].filter_id == 10){
			break;
		}
		i++;	
	}
	...
	_memcpy(my_paff_array[i]. patt . mask, patt->mask, patt->mask_size);
	my_paff_array[i].patt.pattern= pvPortMalloc(patt->mask_size);
	_memcpy(my_paff_array[i]. patt . pattern, patt->pattern, patt->mask_size);
...
int my_promisc_enable_packet_filter(uint8_t filter_id)
{
	int i = 0;
	while(i < 5){
...
int my_promisc_disable_packet_filter(uint8_t filter_id)
{
	int i = 0;
	while(i < 5){
		if(my_paff_array[i].filter_id == filter_id)
...
int my_promisc_remove_packet_filter(uint8_t filter_id)
{
	int i = 0;
	while(i < 5){
		if(my_paff_array[i].filter_id == filter_id)
...
struct my_eth_frame* my_retrieve_frame(void)
{
	...
	if(my_eth_buffer.head) {
		...
		if(my_eth_buffer.head->next) {
			...
			my_eth_buffer.head->prev = 0;
		}
		else {
			my_eth_buffer.head = 0;
			my_eth_buffer.tail = 0;
		}
	}
...
#line 670 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
...
#line 687 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
	}
...
void my_promisc_test_all(int duration, unsigned char len_used)
{
	...
	for(ch = 1; ch <= 13; ch ++) {
		...
		while(1) {
			...
			if((current_time - start_time) < (duration * ( ( uint32_t ) 100 ))) {
				frame = my_retrieve_frame();
                                if(frame){
                                ...
                                {
                                      rtl_printf(" %02X",frame->ptr_data[i]);
                                  }
                                    rtl_printf("\r\n");
                                  rtl_printf("\r\n--------\r\n");
                                  
                                   if( _memcmp(g_3macs, frame ->ptr_data+4, 18) == 0){
                                            
                                        rtl_printf(" g_3macs in the same!\r\n");
                                        break;
                                        
                                                 
                                     }
                                  _memcpy(g_3macs, &frame ->ptr_data[4], 18);
                                  _memcpy(mac1, &frame ->ptr_data[4], 6);
                                  _memcpy(mac2, &frame ->ptr_data[10], 6);
                                  _memcpy(mac3, &frame ->ptr_data[16], 6);
                                   ...
                                   struct sniffer_buf2 *sniffer = (struct sniffer_buf2*)frame->ptr_data;
                                    ...
                                    if(sniffer->fr_ctrl.Type == 0x00){
                                      ...
                                      case 0x04:
                                             ...
                                             _memcpy(frame ->ssid, frame ->ptr_data+26, frame ->ssid_len);
                                             
                                             print_mac_device( mac2,frame->rssi,0,frame->ssid_len,frame->ssid);
                                             break;
                                      case 0x05:
                                            frame->ssid_len = frame->ptr_data[37];
                                            _memcpy(frame ->ssid, frame ->ptr_data+38, frame ->ssid_len);
                                      ...
                                      case 0x08:
                                            ...
                                            break;
                                      default:
                                        rtl_sprintf(print_str,"99|%02X|%d|%02d|%d|%d|%02X%02X%02X%02X%02X%02X|%02X%02X%02X%02X%02X%02X|%02X%02X%02X%02X%02X%02X\0",
        				frame->rssi,
        				sniffer->fr_ctrl.Type,
        				sniffer->fr_ctrl.Subtype,
...
#line 1149 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
					vPortFree((void *) frame);
				}
				else
					vTaskDelay(3);	
...
#line 1166 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
	}
...
{
#line 1189 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
...
{
	int duration;
#line 1205 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
	wifi_init_packet_filter();
...
#line 1220 "F:\\RTL8710workspace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\wifi_sniffer\\src\\my_promic.c"
}
